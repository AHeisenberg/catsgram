...
public class FollowDaoImpl implements FollowDao {
    private static final String SELECT_FROM_CAT_FOLLOW_WHERE_FOLLOWER_ID = "select * from cat_follow where follower_id ?";
    ...
    public List<Post> getFollowFeed(String userId, int max) {
        List<Follow> follows = jdbcTemplate.query(SELECT_FROM_CAT_FOLLOW_WHERE_FOLLOWER_ID, (rs, rowNum) -> makeFollow(rs), userId);
